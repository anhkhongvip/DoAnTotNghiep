...
const HomeRecommend = () => {
  return (
    <HomeRecommendedStyles>
      <Link to="/" className="home-recommend">
        ...
        <div className="home-recommend__content flex mt-10">
          <div className="home-recommend__item">
            <div className="home-recommend__image">
              <img
                src="https://cdn.asahiluxstay.com//uploads/small/image/asahi/resources/2021/07/07/5c7c6-1625652525122.jpg?s=aHR0cHM6Ly9tZWRpYS5keG1iLnZuL2ltYWdlL2FzYWhpL3Jlc291cmNlcy8yMDIxLzA3LzA3LzVjN2M2LTE2MjU2NTI1MjUxMjIucG5n"
                alt=""
              />
            </div>
            <div className="home-recommend__body">
              <div className="home-recommend__rating pt-5 flex items-center">
                <svg
                  width="14"
                  height="15"
                  viewBox="0 0 14 15"
                ...
                <div className="rating-number mr-4 ml-4">4.91 <span className="rating-amount ">(147)</span>
                </div>
              </div>
              <div className="home-recommend__info">
                <h3 className="title sp-line">Nhà vườn sao</h3>
                <div className="location sp-line">
                  <div className="location-icon">
                    ...
                    Xã Phú Kim, Huyện Thạch Thất, Hà Nội
                  </div>
                </div>
                <small className="price">
                  <small>từ</small> 1.275.000 <sup>đ</sup> /đêm
                </small>
              </div>
            </div>
          </div>
